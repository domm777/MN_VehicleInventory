...
namespace MN_VehicleInventory.Domain.Aggregate {
    public class MN_Vehicle {
        // Constructor which initializes the Id property with a new int
        // int is a unique identifier that can be used to uniquely identify each vehicle in the inventory
        ...
        public MN_Vehicle(string vehicleCode, int locationId, string vehicleType) {
            ...
            //Id = locationId; // Id is auto-generated by the database, so I don't set it in the constructor
