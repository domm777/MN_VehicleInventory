...
namespace VehicleInventory.WebAPI.Controllers {
    ...
    public class MN_VehiclesController : ControllerBase {
        private readonly MN_VehicleService _vehicleService;

        // Constructor Injection
        public MN_VehiclesController(MN_VehicleService vehicleService) {
        ...
        // GET: api/vehicles/{id}
        [HttpGet("{id}")]
        public async Task<ActionResult<MN_VehicleDto>> GetById(Guid id) {
